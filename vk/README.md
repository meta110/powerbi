...
1. Получите токен по [этой инструкции](https://yogabi.ru/services/vkauth/) или используйте имеющийся, например, от [rvkstat](https://github.com/selesnow/rvkstat)
...
--------|---|---------------------|---
access_token|text|-|Токен доступа. Получите по [этой инструкции](https://yogabi.ru/services/vkauth/) или используйте имеющийся
...
access_token можно получить по [этой инструкции](https://yogabi.ru/services/vkauth/) или по инструкции [Алексея Селезнева](https://github.com/selesnow) к функции [rvkstat](https://github.com/selesnow/rvkstat)
